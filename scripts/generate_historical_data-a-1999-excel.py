#!/usr/bin/env python3
"""Extract pre-WDI annual series (cols D,E,F) from provided data_a_1999.xlsx."""
...
OUTPUT = (
    paths.PROCESSED
    / "historical"
    / "converted_historical_data-a-1999-excel_1853-01_1963-12.csv"
)


def main() -> int:
    if not paths.DATA_A_1999_XLSX.exists():
        print(f"Missing {paths.DATA_A_1999_XLSX}", file=sys.stderr)
        return 1
