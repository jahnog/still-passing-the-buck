...
images, the two helper modules the notebook imports, and pyproject.toml.
...
DATA_FILES: tuple[str, ...] = (
    "data/processed/indicators/converted_indicators_wdi-argentina_1960-01_2025-12.csv.gz",
    ...
    "data/processed/historical/converted_historical_data-a-1999-excel_1853-01_1963-12.csv",
    ...
    "data/processed/interest/converted_interest_us-real-yield-10y_1998-01_2025-12.csv",
    "data/provided/restructuring-2005-sensitivity.csv",
    "data/processed/fiscal/converted_fiscal_denominator-neutral_1960-01_2025-12.csv",
)
...
# Repo-root files the notebook reads (version badge + project-root marker).
