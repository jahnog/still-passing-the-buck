...
def test_quasi_fiscal_csv_measured_years_and_cross_check():
    ...
    # The API stock and World Bank nominal-GDP denominator cover complete 2025.
    assert measured["Year"].min() <= 2003 and measured["Year"].max() == 2025
    # Calibration years must stay close to the documented anchors.
