...
Render the executed notebook to PDF with `scripts/render_notebook_paper.py`.
...
The `--output` path is generated and is not a committed file.
...
# Keep the intermediate print HTML for inspection.
python3 scripts/render_notebook_paper.py \
